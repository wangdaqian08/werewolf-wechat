...
Page({
  data: {
    ...
    players: [
      {
        seatNumber: 1, name: '玩家1', role: '狼人', alive: true,
      },
      {
        seatNumber: 2, name: '玩家2', role: '狼人', alive: true,
      },
      {
        seatNumber: 3, name: '玩家3', role: '村民', alive: true,
      },
      {
        seatNumber: 4, name: '玩家4', role: '村民', alive: true,
      },
      {
        seatNumber: 5, name: '玩家5', role: '女巫', alive: true,
      },
      {
        seatNumber: 6, name: '玩家6', role: '预言家', alive: true,
      },
      {
        seatNumber: 7, name: '玩家7', role: '村民', alive: true,
      },
      {
        seatNumber: 8, name: '玩家8', role: '村民', alive: true,
      },
      {
        seatNumber: 9, name: '玩家9', role: '守卫', alive: true,
      },
      {
        seatNumber: 10, name: '玩家10', role: '村民', alive: false,
      },
      {
        seatNumber: 11, name: '玩家11', role: '狼人', alive: true,
      },
      {
        seatNumber: 12, name: '玩家12', role: '村民', alive: true,
      },
    ],
  },
  ...
  skipStage(e) {
    const stageId = e.currentTarget.dataset.stage;
    const currentIndex = this.data.gameStages.findIndex((stage) => stage.id === stageId);
  ...
  togglePlayerStatus(e) {
    ...
    const playerIndex = players.findIndex((player) => player.seatNumber === seatNumber);
